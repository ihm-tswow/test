...
{: .code-example }
`GetAlivePlayersCountByTeam(team): uint32`
...
{: .code-example }
`GetBGAlivePlayerCount(team?): uint32`
...
{: .code-example }
`GetBonusHonorFromKillCount(kills): uint32`
...
{: .code-example }
`GetFreeSlotsForTeam(team): uint32`
