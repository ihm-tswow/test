...
{: .code-example }
`DurabilityRepair(position, cost, discountMod): uint32`
...
{: .code-example }
`DurabilityRepairAll(cost, discountMod, guildBank): uint32`
...
{: .code-example }
`GetBaseSkillValue(skill): uint16`
...
{: .code-example }
`GetItemCount(entry, checkinBank): uint32`
...
{: .code-example }
`GetPureMaxSkillValue(skill): uint16`
...
{: .code-example }
`GetPureSkillValue(skill): uint16`
...
{: .code-example }
`GetReputationRank(faction): uint32`
...
{: .code-example }
`GetReqKillOrCastCurrentCount(questId, entry): uint16`
...
{: .code-example }
`GetSkillPermBonusValue(skill): int16`
...
{: .code-example }
`GetSkillTempBonusValue(skill): int16`
...
{: .code-example }
`GetSpecsCount(entry, mapid, zone): uint8`
...
{: .code-example }
`GetSpellCooldownDelay(spellId): uint32`
