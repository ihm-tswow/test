...
{: .code-example }
`CountPctFromCurHealth(health): int32`
...
{: .code-example }
`CountPctFromMaxHealth(health): int32`
...
{: .code-example }
`GetBaseSpellPower(spellschool): uint32`
...
{: .code-example }
`PowerSelectorHelper(unit, powerType): uint32`
...
{: .code-example }
`SetResistance(school, val): uint32`
