...
{: .code-example }
`OnGossipHello((obj,player,cancel) => void`
#### Event Parameters
...
{: .code-example }
`OnGossipSelect((obj,player,menuId,selection,cancel) => void`
#### Event Parameters
...
{: .code-example }
`OnGossipSelectCode((obj,player,menuId,selection,text,cancel) => void`
#### Event Parameters
