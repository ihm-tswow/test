...
| `heal` | [`TSMutable`](../classes/TSMutable)<`uint32`\> |
...
| `crit` | [`TSMutable`](../classes/TSMutable)<`float`\> |
...
| `attacker` | [`TSUnit`](../classes/TSUnit) |
| `victim` | [`TSUnit`](../classes/TSUnit) |
| `missChance` | [`TSMutable`](../classes/TSMutable)<`float`\> |
| `critChance` | [`TSMutable`](../classes/TSMutable)<`float`\> |
| `dodgeChance` | [`TSMutable`](../classes/TSMutable)<`float`\> |
| `blockChance` | [`TSMutable`](../classes/TSMutable)<`float`\> |
| `parryChance` | [`TSMutable`](../classes/TSMutable)<`float`\> |
| `attackType` | [`WeaponAttackType`](../enums/WeaponAttackType) |
