...
{: .code-example }
`CreateTSMutable<T>(ptr): TSMutable<T>`
...
**Returns:** 
[`TSMutable`](interfaces/TSMutable)<`T`\>
...
{: .code-example }
`GetTalentSpellCost(entry): uint32`
